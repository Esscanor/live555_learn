...
{
public:
    DelayInterval(time_base_seconds seconds, time_base_seconds useconds): Timeval(seconds, useconds) {}
};
...
private:
    ...
    DelayInterval fDeltaTimeRemaining;   // 延时的时间值

    intptr_t fToken;                     // 标记
    static intptr_t tokenCounter;        // 标记的计数
};
...
private:
    ...
    EventTime fLastSyncTime;            //上一次同步的时间值
};
